...
const VideoStyleSettings = () => {
  const { currentItem, previewMode } = useContext(GlobalContext);
  const { t } = useTranslation();
  const { findStyleItem, cardItemElement, inputChange, updateItemStyles } =
    useLayout();
      ...
      <>
        ...
        <div className="card-item">
          <div className="width-full">
            <div className="card-item-title">{t("video_url")}</div>
            <div className="margin-top-6">
        ...
        <div className="card-item">
          <div className="width-full">
            <div className="card-item-title">{t("video_alt")}</div>
            <div className="margin-top-6">
        ...
        {cardItemElement(
          ...
          <Switch
            ...
            className={classNames(
              width === "auto" ? "bg-sky-500" : "bg-gray-400"
            )}
            onChange={() => {
...
export default VideoStyleSettings;
